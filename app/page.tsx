      ...
      <div className="flex justify-center py-[140px] flex-col items-center ">
        ...
        <div className="xl:pt-[100px]  w-full flex justify-center relative curve-image">
          ...
          <div className="w-3/4 p-10 border border-boxBorderColor rounded-[10px] flex flex-col items-center relative top-[100px] gap-5 text-black">
            ...
            <h3 className="w-2/3 text-center text-[40px] font-[700] leading-[50px] text-primary">Comprehensive Cloud Security Management Solutions</h3>
            <h2 className="w-2/3 text-center font-[400] leading-[24px] text-[24px] text-primary">Real-time threat detection, automated compliance checks, and robust data encryption for your cloud environment.</h2>
            <Image
              src={Group}
              alt="Contact Us Image"
            />
